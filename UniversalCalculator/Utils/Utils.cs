...
namespace Calculator.Utils
{
	public static class Utils
	{
		...
		{
			TextBlock primaryDisplay = MathCalculator.mathCalculator.primaryDisplay;
			TextBlock secondaryDisplay = MathCalculator.mathCalculator.secondaryDisplay;
			TextBlock errorDisplay = MathCalculator.mathCalculator.errorDisplay;
		...
		{
			MathCalculator.mathCalculator.primaryDisplay.Text = "";
			MathCalculator.mathCalculator.secondaryDisplay.Text = "";
		}
